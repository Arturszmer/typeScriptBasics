...
//
//
// function getMinimumCrew(crew){
//     const split = crew.replace(",", "").split('-');
//
//     if (split.length < 2){
...
//     }
// }
// function getMaximumCrew(crew){
//     const split = crew.replace(",", "").split('-');
//
//     if  (split.length < 2){
//             return parseFloat(split[0]) || 'unknown';
//         } else {
//             return parseFloat(split[1]) || 'unknown';
//         }
// }
// const getCrew = crew => {
//
//     const minMaxCrew = crew.replace(',','').split('-');// removing commas and splitting values
//     return {min_crew: parseInt(minMaxCrew[0]), max_crew: parseInt(minMaxCrew[1])} || 'unknown'
//
// };
// const crewmap = starships.map(crew => ({
//     crew: getCrew(crew.crew)
// }))
// console.log(crewmap)
//
// console.log(starships)
// const starshipsMapped = starships.map(starshipsModel => ({
//
//         name: starshipsModel.name,
//         model: starshipsModel.model,
//         manufacturer: starshipsModel.manufacturer,
//         cost_in_credits: parseFloat(starshipsModel.cost_in_credits) || 'unknown',
//         max_atmospgering_speed: parseInt(starshipsModel.max_atmosphering_speed) || 'unknown',
//         min_crew: getMinimumCrew(starshipsModel.crew),
//         max_crew: getMaximumCrew(starshipsModel.crew)
//     }
// ));
// console.log(starshipsMapped);
//
//
// const starshipsBigCrew = starshipsMapped.filter(bigCrew =>
//     bigCrew.min_crew >= 100
// );
// console.log(starshipsBigCrew)
//
// const findShip = starshipsMapped.find(ship => ship.name === 'Millennium Falcon');
// console.log(findShip)
//
// const findIndexShip = starshipsMapped.findIndex(shipIndex => shipIndex.name === 'Death Star')
// console.log('Index of Death Star is: '+ findIndexShip)
//
// const fiveMostExpensiveShips = starships.map(starshipsModel => ({
//
//         name: starshipsModel.name,
//         model: starshipsModel.model,
//         manufacturer: starshipsModel.manufacturer,
//         cost_in_credits: parseFloat(starshipsModel.cost_in_credits),
//         max_atmospgering_speed: starshipsModel.max_atmosphering_speed === 'n/a'
//             ? 0 : parseInt(starshipsModel.max_atmosphering_speed), //zmienić 'inne niż liczby' na zero
//         crew: parseInt(starshipsModel.crew) // rozdzielić na minimalną i maksymalną ilość osób załogi
//     }
// )).filter(filterCost => filterCost.cost_in_credits).sort(function (a, b )
// {return b.cost_in_credits - a.cost_in_credits;  }).slice(0, 5);
// console.log(fiveMostExpensiveShips)
//
//
//
// const mappedCost_in_Credits = starshipsMapped.map(List => ({
//     cost_in_Credits: List.cost_in_credits
// }))
// console.log(mappedCost_in_Credits);
//
// const mappedAtmoSpeed = starshipsMapped.map(List => ({
//     speed: List.max_atmospgering_speed
// }))
// console.log(mappedAtmoSpeed);
