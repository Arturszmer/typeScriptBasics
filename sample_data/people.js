...
// console.log(people)
//
// const mappedPeopleNameHeightMass = people.map(person  => ({
//     name: person.name,
//     height: Number(person.height),
//     mass: person.mass === 'unknown' ? person.mass = undefined : parseInt(person.mass)
//
// }))
//     .filter(personMass =>
//      personMass.mass !== undefined
// ).filter(personHeight => personHeight.height <= 170)
//
// console.log(mappedPeopleNameHeightMass)
// const mappedYoda = people.findIndex(person => person.name == 'Yoda')
// console.log(mappedYoda)
//
// const mappedPeopleNameHeightMass2 = people.map(person  => ({
//     name: person.name,
//     height: Number(person.height),
//     mass: person.mass === 'unknown' ? person.mass = 0 : parseInt(person.mass)
//
// }))
// const initialValue = 0;
// const massPeople = mappedPeopleNameHeightMass2.reduce((previousValue, currentValue, index) =>
//     previousValue + currentValue.mass, initialValue
// );
